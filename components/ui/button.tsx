...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-4 whitespace-nowrap rounded-lg text-sm transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-3 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer font-bold",
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          "bg-background text-foreground hover:bg-card hover:border-input border border-background",
      ...
      size: {
        ...
        "card-action": "h-auto rounded-lg px-4 py-3 text-sm",
        "finance-submit": "h-13.25 w-full rounded-lg text-sm",
