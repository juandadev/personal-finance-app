...
export function Logo({ className, collapsed = false }: LogoProps) {
  ...
  return (
    <div
      className={cn(
        "text-primary-foreground flex items-center justify-start",
        className,
      )}
    >
      <motion.svg
        width={collapsed ? 14 : 122}
        height="22"
        initial={false}
        animate={{
          width: collapsed ? 14 : 122,
          viewBox: collapsed ? "0 0 14 22" : "0 0 122 22",
        }}
        transition={shouldReduceMotion ? { duration: 0 } : logoTransition}
        fill="none"
